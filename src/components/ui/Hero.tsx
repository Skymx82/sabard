...
// Import dynamique du composant 3D pour éviter les problèmes de rendu côté serveur
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 grid grid-cols-1 md:grid-cols-2 z-10">
        ...
        {/* Colonne de droite pour la scène 3D */}
        <div className="relative h-full">
          {/* Intentionnellement vide pour laisser la place au modèle 3D */}
        </div>
      </div>
