            ...
            <div className="w-full md:w-1/2 relative">
              ...
              <div className="relative rounded-lg overflow-hidden shadow-xl">
                <div className="aspect-w-16 aspect-h-9 w-full h-[350px] relative">
                  <Image
                    src="/images/about/presentation1.png"
                    alt="Bâtiment SABARD"
                    fill
            ...
            {[
              ...
              >
                <div className="relative h-56 overflow-hidden">
                  <Image
                    src={index === 0 ? "/images/about/credit-agricole.jpg" : 
                         index === 1 ? "/images/about/jardins-idyllis.jpg" : 
                         "/images/about/gendarmerie-gien.jpg"}
                    alt={project.title}
                    fill
